...
GNUTERM = "wxt"
plot [] [0:1200000] 'Exercise2.dat' u 1 w lines t 'Crossover rate 0.7', 'Exercise2.dat' u 2 w lines t 'Mutation only', 'Exercise4.dat' u 1 w lines t 'Random-mutation hill climbing'
#    EOF
